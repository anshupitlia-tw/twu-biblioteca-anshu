...
public class LibraryFactoryTest {
    ...
    public void setLibrary() {
        ...
        library = new com.twu.biblioteca.models.Library(listOfBooks, listOfMovies, session);
    }
    ...
    public void shouldHaveAllTheBooksInTheLibrary() {
        com.twu.biblioteca.authentication.Session session = new com.twu.biblioteca.factories.SessionFactory().createGuestSession();
        assertEquals(library.getAvailableBookListForDisplay(), new com.twu.biblioteca.factories.LibraryFactory().establishLibrary(session).getAvailableBookListForDisplay());
    }

    @Test
    public void shouldHaveAllTheMoviesInTheLibrary() {
        com.twu.biblioteca.authentication.Session session = new com.twu.biblioteca.factories.SessionFactory().createGuestSession();
        assertEquals(library.getMovieListForDisplay(), new com.twu.biblioteca.factories.LibraryFactory().establishLibrary(session).getMovieListForDisplay());
    }
}
