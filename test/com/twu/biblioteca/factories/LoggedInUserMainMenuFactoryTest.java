...
public class LoggedInUserMainMenuFactoryTest {
    ...
    public void shouldHaveAMenuForListingBooks() {
        ...
        com.twu.biblioteca.main_menu.MainMenu mainMenu =  new com.twu.biblioteca.factories.LoggedInUserMainMenuFactory().establishMainMenu(session, library, messages, users, userInterface);
    ...
    public void shouldHaveAMenuForViewingUserDetails() {
        ...
        com.twu.biblioteca.user_interface.UserInterface userInterface = mock(com.twu.biblioteca.user_interface.UserInterface.class);
        com.twu.biblioteca.main_menu.MainMenu mainMenu = new com.twu.biblioteca.factories.LoggedInUserMainMenuFactory().establishMainMenu(session, library, messages, users, userInterface);
        assertEquals(com.twu.biblioteca.menu_items.UserDetailsMenuItem.class, mainMenu.getMenu("8").getClass());
    }
}
