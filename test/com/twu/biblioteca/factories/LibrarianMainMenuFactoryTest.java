...
public class LibrarianMainMenuFactoryTest {
    ...
    public void shouldHaveAMenuForListingBooks() {
        ...
        com.twu.biblioteca.main_menu.MainMenu mainMenu =  new com.twu.biblioteca.factories.LibrarianMainMenuFactory().establishMainMenu(session, library, messages, users, userInterface);
    ...
    public void shouldHaveAMenuForLoggingOut() {
        ...
        com.twu.biblioteca.user_interface.UserInterface userInterface = mock(com.twu.biblioteca.user_interface.UserInterface.class);
        com.twu.biblioteca.main_menu.MainMenu mainMenu = new com.twu.biblioteca.factories.LibrarianMainMenuFactory().establishMainMenu(session, library, messages, users, userInterface);
        assertEquals(com.twu.biblioteca.menu_items.LogoutMenuItem.class, mainMenu.getMenu("7").getClass());
    }
    ...
    public void shouldHaveAMenuForDisplayingCheckedOutBookDetails() {
        ...
        com.twu.biblioteca.user_interface.UserInterface userInterface = mock(com.twu.biblioteca.user_interface.UserInterface.class);
        com.twu.biblioteca.main_menu.MainMenu mainMenu = new com.twu.biblioteca.factories.LibrarianMainMenuFactory().establishMainMenu(session, library, messages, users, userInterface);
        assertEquals(com.twu.biblioteca.menu_items.CheckedOutBookDetailsMenuItem.class, mainMenu.getMenu("8").getClass());
    }
    ...
    public void shouldHaveAMenuForViewingUserDetails() {
        ...
        com.twu.biblioteca.user_interface.UserInterface userInterface = mock(com.twu.biblioteca.user_interface.UserInterface.class);
        com.twu.biblioteca.main_menu.MainMenu mainMenu = new com.twu.biblioteca.factories.LibrarianMainMenuFactory().establishMainMenu(session, library, messages, users, userInterface);
        assertEquals(com.twu.biblioteca.menu_items.UserDetailsMenuItem.class, mainMenu.getMenu("9").getClass());
    }
}
